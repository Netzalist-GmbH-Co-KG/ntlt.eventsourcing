...
namespace ntlt.eventsourcing.autx.Infrastructure.Extensions;
...
public static class HttpContextExtensions
{
    ...
    {
        if (context.Items.TryGetValue("SessionId", out var sessionId) && sessionId is Guid guid) return guid;
    ...
    {
        if (context.Items.TryGetValue("Session", out var session) && session is Session sessionObj) return sessionObj;
